...
/// <summary>
/// Historique des actions sur un bon d'entrée.
/// EF maps Id → IdHistory column.
/// </summary>
public sealed class BonEntreeHistory : BaseEntity
{
    public int BonId { get; private set; }
    public ActionBonEntree Action { get; private set; }
    ...
    private BonEntreeHistory() { }

    public BonEntreeHistory(
        int bonId,
        ActionBonEntree action,
