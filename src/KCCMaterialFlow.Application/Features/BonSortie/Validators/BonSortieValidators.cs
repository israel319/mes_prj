...
namespace KCCMaterialFlow.Application.Features.BonSortie.Validators;
...
public class BonSortieApprovalRequestValidator : AbstractValidator<BonSortieApprovalRequest>
{
    public BonSortieApprovalRequestValidator()
    {
        RuleFor(x => x.IdBon)
            .GreaterThan(0).WithMessage("L'identifiant du bon est invalide.");
