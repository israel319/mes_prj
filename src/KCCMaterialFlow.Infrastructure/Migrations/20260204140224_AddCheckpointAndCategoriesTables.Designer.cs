...
namespace KCCMaterialFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260204140224_AddCheckpointAndCategoriesTables")]
    partial class AddCheckpointAndCategoriesTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.CategorieSortie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CategoriesSortie", "ref");
                });

            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.Checkpoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Checkpoints", "ref");
                });

            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.Compagnie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Compagnies", "ref");
                });

            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.Departement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Departements", "ref");
                });

            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Employees", "ref");
                });

            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.NotificationRejet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NotificationsRejet", "dbo");
                });

            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.PassageCheckpoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PassagesCheckpoint", "dbo");
                });

            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.RaisonSortie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RaisonsSortie", "ref");
                });

            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.Site", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KCCMaterialFlow.Module.Shared.Entities.CategorieSortie", b =>
                {
                    ...
                    b.Property<bool>("RequiertApprobationEnvironnement")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasColumnName("RequiertApprobationEnvironnement");

                    b.Property<bool>("RequiertApprobationIT")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasColumnName("RequiertApprobationIT");

                    b.HasKey("IdCategorie");

                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_CategoriesSortie_Code");

                    b.HasIndex("OrdreAffichage")
                        .HasDatabaseName("IX_CategoriesSortie_Ordre");

                    b.ToTable("CategoriesSortie", "shared");
                });
            ...
            modelBuilder.Entity("KCCMaterialFlow.Module.Shared.Entities.ParametreSysteme", b =>
                {
                    ...
                    b.ToTable("ParametresSysteme", (string)null);
            ...
            modelBuilder.Entity("KCCMaterialFlow.Module.Shared.Entities.RaisonSortie", b =>
                {
                    b.Property<int>("IdRaison")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("IdRaison");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdRaison"));
                    ...
                    b.HasIndex("CategorieId", "Code")
                        .IsUnique()
                        .HasDatabaseName("IX_RaisonsSortie_Categorie_Code");

                    b.HasIndex("CategorieId", "OrdreAffichage")
                        .HasDatabaseName("IX_RaisonsSortie_Categorie_Ordre");

                    b.ToTable("RaisonsSortie", "shared");
                });
            ...
            modelBuilder.Entity("KCCMaterialFlow.Module.Shared.Entities.TypeMateriel", b =>
                {
                    ...
                    b.ToTable("TypesMateriels", (string)null);
            ...
            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.Checkpoint", b =>
                {
                    b.HasOne("KCCMaterialFlow.Core.Entities.Site", "Site")
                        .WithMany()
            ...
            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.Employee", b =>
                {
                    b.HasOne("KCCMaterialFlow.Core.Entities.Compagnie", "Compagnie")
                        .WithMany("Employees")
                        .HasForeignKey("CompagnieId");

                    b.HasOne("KCCMaterialFlow.Core.Entities.Departement", "Departement")
                        .WithMany()
            ...
            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.PassageCheckpoint", b =>
                {
                    b.HasOne("KCCMaterialFlow.Core.Entities.Checkpoint", "Checkpoint")
                        .WithMany()
            ...
            modelBuilder.Entity("KCCMaterialFlow.Core.Entities.RaisonSortie", b =>
                {
                    b.HasOne("KCCMaterialFlow.Core.Entities.CategorieSortie", "Categorie")
                        .WithMany("Raisons")
