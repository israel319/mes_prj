...
namespace KCCMaterialFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260304055402_AddContratTable")]
    partial class AddContratTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.CategorieSortie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.Checkpoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.Compagnie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.Contrat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Contrats", "ref");
                });

            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.Departement", b =>
                {
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.NotificationRejet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.PassageCheckpoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.RaisonSortie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.Site", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.SoldeMateriel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.Checkpoint", b =>
                {
                    b.HasOne("KCCMaterialFlow.Domain.Entities.Shared.Site", "Site")
                        .WithMany()
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.Contrat", b =>
                {
                    b.HasOne("KCCMaterialFlow.Domain.Entities.Shared.Compagnie", "Compagnie")
                        .WithMany("Contrats")
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.Employee", b =>
                {
                    ...
                    b.HasOne("KCCMaterialFlow.Domain.Entities.Shared.Departement", "Departement")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.PassageCheckpoint", b =>
                {
                    b.HasOne("KCCMaterialFlow.Domain.Entities.Shared.Checkpoint", "Checkpoint")
                        .WithMany()
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Shared.RaisonSortie", b =>
                {
                    b.HasOne("KCCMaterialFlow.Domain.Entities.Shared.CategorieSortie", "Categorie")
                        .WithMany("Raisons")
