...
namespace KCCMaterialFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260424093935_EmployeeAsUser_AddNiveauAdminAndDisplayName")]
    partial class EmployeeAsUser_AddNiveauAdminAndDisplayName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KCCMaterialFlow.Domain.Entities.Utilisateur", b =>
                {
                    ...
                    b.HasIndex("Matricule")
                        .HasDatabaseName("IX_Utilisateurs_Matricule")
                        .HasFilter("[Matricule] IS NOT NULL");
