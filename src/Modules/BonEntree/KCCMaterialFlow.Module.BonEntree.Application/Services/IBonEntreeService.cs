...
public interface IBonEntreeService
{
    ...
    Task<Entities.BonEntree?> GetAsync(int id, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<Entities.BonEntree>> GetPendingApprovalsAsync(CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<Entities.Approbation>> GetApprobationsAsync(int bonId, CancellationToken cancellationToken = default);
...
/// Champs: Code produit/N° Serial | Désignation | Qté | FROM | TO
/// </summary>
...
public class BonEntreeResult
{
    ...
    public Entities.BonEntree? BonEntree { get; set; }
    public List<string> Errors { get; set; } = [];

    public static BonEntreeResult Ok(Entities.BonEntree bon, string? message = null) =>
