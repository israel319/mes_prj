...
/// Inclut les matériels disponibles pour la sortie avec leurs quantités
/// </summary>
...
/// Contient la quantité initiale et permet de sélectionner/modifier la quantité à sortir
/// </summary>
public class MaterielPourSortieDto
{
    ...
    /// <summary>
    /// Indique si ce matériel est sélectionné pour la sortie
    /// </summary>
    public bool EstSelectionne { get; set; }
    
    /// <summary>
    /// Quantité à sortir (saisie par l'utilisateur)
    /// </summary>
