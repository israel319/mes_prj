...
/// Optimisé pour les grilles de données et les affichages en liste.
/// </summary>
public class BonSortieListDto
{
    public int IdBon { get; set; }
    public string NumeroReference { get; set; } = string.Empty;
    public string TypeSortie { get; set; } = string.Empty; // Externe, Interne, Pret
    ...
    // Compagnie/Destinataire (pour sorties externes)
    ...
    // BonEntree associé (si applicable)
