...
public interface IBonSortieService
{
    ...
    /// </summary>
    Task<Entities.BonSortie?> GetAsync(int id, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<IReadOnlyList<Entities.BonSortie>> GetPendingApprovalsAsync(CancellationToken cancellationToken = default);

    /// <summary>
    /// Récupère l'historique des approbations d'un bon de sortie
    /// </summary>
    Task<IReadOnlyList<Entities.ApprobationSortie>> GetApprobationsAsync(int bonId, CancellationToken cancellationToken = default);
    ...
    /// Approuve un bon
    /// </summary>
    Task<BonSortieResult> ApproveAsync(ApprovalRequest request, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<BonSortieResult> ReturnForModificationAsync(ApprovalRequest request, CancellationToken cancellationToken = default);
    ...
    Task<QRCodeValidationResult> ValidateQRCodeAsync(string scannedCode, CancellationToken cancellationToken = default);
    ...
    Task<DTOs.BonEntreeDetailsPourSortieDto?> GetBonEntreeDetailsForSortieAsync(int bonEntreeId, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Token d'annulation</param>
    /// <returns>Détails du BEM avec matériels ou null si non trouvé</returns>
    Task<DTOs.BonEntreeDetailsPourSortieDto?> SearchBonEntreeByReferenceAsync(string numeroReference, CancellationToken cancellationToken = default);
...
public class BonSortieResult
{
    ...
    public Entities.BonSortie? Bon { get; set; }
    public List<string> Errors { get; set; } = [];

    public static BonSortieResult Ok(Entities.BonSortie bon, string? message = null) =>
...
{
    public IReadOnlyList<Entities.BonSortie> Items { get; set; } = [];
...
public class QRCodeValidationResult
{
    ...
    public static QRCodeValidationResult Valid(Entities.BonSortie bon) => new()
    {
        IsValid = true,
    ...
    public static QRCodeValidationResult Invalid(string message) => new()
    {
        IsValid = false,
        Message = message
    };
